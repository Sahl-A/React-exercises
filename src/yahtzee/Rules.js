...
// If 3 of any dice AND 2 of any dice are found, score 25, else 0

class FullHouse extends Rule {
  evalRoll = dice => {
    // If we have only 2 frequences
...
class SmallStraight extends Rule {
  evalRoll = dice => {
    ...
    // if it has 234 and the other either 1 or 5
    if(d.has(2) && d.has(3) && d.has(4) && (d.has(1) || d.has(5))) return this.score;

    // if it has 345 and the other either 2 or 6
